    ...
    public function close()
    {
        ...
        switch (get_class($this->object)) {
            ...
            case 'PHPExcel_Shared_Escher_DggContainer':
                ...
                $header = pack('vvV', $recVerInstance, $recType, wfPhpfunc::strlen($dggData));
                ...
                $recInstance    = 0x0000;
                $recType        = 0xF000;
                $length            = wfPhpfunc::strlen($innerData);
            ...
            case 'PHPExcel_Shared_Escher_DggContainer_BstoreContainer_BSE':
                ...
                $tag = 0;
                $size = wfPhpfunc::strlen($innerData);
                $cRef = 1;
                $foDelay = 0; //todo
                $unused1 = 0x0;
                $cbName = 0x0;
            ...
            case 'PHPExcel_Shared_Escher_DgContainer_SpgrContainer':
                ...
                foreach ($this->object->getChildren() as $spContainer) {
                    ...
                    $totalSize += wfPhpfunc::strlen($spData);
                    $spOffsets[] = $totalSize;
            ...
            case 'PHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer':
                ...
                if ($this->object->getOPTCollection()) {
                    ...
                    $length            = wfPhpfunc::strlen($optData);
                ...
                if ($this->object->getStartCoordinates()) {
                    ...
                    $length            = wfPhpfunc::strlen($clientAnchorData);
                ...
                if (!$this->object->getSpgr()) {
                    ...
                    $length = wfPhpfunc::strlen($clientDataData);
